...
export const WeeklyReportFiltersComponent: React.FC<
...
> = ({
  ...
  const hasActiveFilters =
    filters.year || filters.status || filters.startDate || filters.endDate;
      ...
      <CardContent className='p-4'>
        ...
        <div className='flex items-center gap-4 mb-4'>
          ...
          <Select
            ...
            onValueChange={value =>
              onFiltersChange({
                status: (value as WeeklyReportStatus) || undefined,
              })
            }
            disabled={isLoading}
          >
            ...
            <SelectContent>
              ...
              <SelectItem value={WeeklyReportStatus.GENERATING}>
                생성 중
              </SelectItem>
